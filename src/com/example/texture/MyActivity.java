...
public class MyActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        Log.d("glDemo", "on texture available");
        Thread t = new RenderThread(getResources(), surfaceTexture);
        t.start();
    }

    @Override
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int width, int height) {
        Log.d("glDemo", "on texture changed");
    }

    @Override
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        Log.d("glDemo", "on texture destroyed");
        return false;
    }

    @Override
    public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        Log.d("glDemo", "on texture updated");
    }

    private static class RenderThread extends Thread {
        static final String LOG_TAG = "glDemo";
        ...
        public void run() {
            ...
            int texture = loadTexture(R.raw.opera);
...
//            while (!mFinished) {
            Log.d("glDemo", "run render thread ....");
            checkCurrent();
